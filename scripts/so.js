...
function getSoFeatures() {
	const soFeat = {gecko: true, clipboard: true, dpi: true, recycle: true, gdiplus: true, segoe: true, findPlay: true}
	...
	// Scripting
	if (utils.IsFile && utils.IsFile(fb.ProfilePath + 'foo_spider_monkey_panel\\package_data\\{F5E9D9EB-42AD-4A47-B8EE-C9877A8E7851}\\foo_lastfm_img.vbs')) {
		try {
			new ActiveXObject('Scripting.FileSystemObject');
			new ActiveXObject('MSXML2.XMLHTTP');
			new ActiveXObject('ADODB.Stream');
		} catch (e) {soFeat.findPlay = false;}
	}
	// UI
